...
import { EmailCircle, GithubCircle, LinkedinCircle, Send } from "../../../../Assets/Svg";
  ...
  return (
    ...
    >
      <Grid container justifyContent={"center"}>
        <Grid container item xs={11} sm={10} className={classes.contactCard}>
          <Grid item xs={12} md={5}>
            <Grid component={'h1'} className={classes.sectionTitle}><Grid component='span' className={classes.contactColor}>Contact</Grid> Me</Grid>
            <Grid className={classes.contactSubTitle}>Let's work together</Grid>
            <Grid className={classes.contactText}>
              Whether it's discussing a potential collaboration, exploring new project ideas, or simply engaging in the vibrant tech community, I'm always eager to connect.
              If you have a project in mind, a question about web development, or just want to say hello, feel free to reach out using the contact form below. I'm excited to hear from you and explore how we can bring your ideas to life!
            </Grid>
          ...
          <Grid item xs={12} md={7} component='form'
            ref={form} onSubmit={sendEmail}
            className={joinStyleClasses(classes.contactFieldCard, context.mode === "DARK" ? classes.contactFieldCardDark : classes.contactFieldCardLight)}>
            <Grid container spacing={2} >
              ...
              <Grid item xs={12} className={classes.submitBtncontainer}>
                <Button type='submit' disabled={submitRequest} className={joinStyleClasses(
                  classes.submitBtn,
                  context.mode === 'DARK' ? classes.submitBtnDark : classes.submitBtnLight
                )}>Send</Button>
              </Grid>
            </Grid>
          </Grid>
