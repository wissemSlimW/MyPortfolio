...
export const SKILL_CARDS: Skill[] = [
  ...
  { id: "nestJs", logo: skillsLogos.nestJs, name: "NestJs" },
  { id: "tailwindCss", logo: skillsLogos.tailwindCss, name: "Tailwind Css" },
  { id: "html", logo: skillsLogos.html, name: "HTML" },
  { id: "css", logo: skillsLogos.css, name: "CSS" },
  { id: "redux", logo: skillsLogos.redux, name: "redux" },
  { id: "bootstrap", logo: skillsLogos.bootstrap, name: "Bootstrap" },
  { id: "agile", logo: skillsLogos.agile, name: "Agile" },
  { id: "storybook", logo: skillsLogos.storybook, name: "Storybook" },
  { id: "git", logo: skillsLogos.git, name: "Git" },
  { id: "github", logo: skillsLogos.github, name: "Github" },
  { id: "jira", logo: skillsLogos.jira, name: "Jira" },
  { id: "monorepo", logo: skillsLogos.monorepo, name: "Monorepo" },
  { id: "turborepo", logo: skillsLogos.turborepo, name: "Turborepo" },
  { id: "sass", logo: skillsLogos.sass, name: "Sass" },
  { id: "framerMotion", logo: skillsLogos.framerMotion, name: "Framer Motion" },
  { id: "angular", logo: skillsLogos.angular, name: "Angular" },
  { id: "svelte", logo: skillsLogos.svelte, name: "Svelte" },
